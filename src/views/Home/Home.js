      ...
      <main>
        <aside>
          <nav>
            <ul>
              <li>CONTACTO</li>
              <a href="mailto:nfessia@gmail.com">
                <li>nfessia@gmail.com</li>
              </a>
              <a href="tel: +543424782338">
                <li>342 4782338</li>
              </a>
              <a
            ...
            <ul>
              <li>PROYECTOS EN CONJUNTO</li>
              <a href="/">
                <li>
                  <div className="container-img-trab-conj">
                    <img
                      className="img-trab-conj"
                      src="https://i.ibb.co/JC5ZHft/imagen-natifessia-Mesa-de-trabajo-1.png"
                      alt=""
                    />
                  </div>
